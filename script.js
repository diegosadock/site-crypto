...
function definirMoeda(obj, moeda) {
    ...
    let valVariacao = parseFloat(variacao);
    ...
    document.getElementById("var"+moeda).innerHTML = valVariacao.toLocaleString("pt-BR", {minimumFractionDigits: 2}, {maximumFractionDigits: 2}) + "% <i class=\"fa-solid fa-sort-up\"></i>";
